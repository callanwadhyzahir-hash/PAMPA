...
export const TENANT_PERMISSIONS = [
  ...
  permission(
    ...
    'catalog',
    'Consultar la configuración del catálogo público de la empresa.',
  ),
  permission(
    'catalog.manage',
    'Gestionar catálogo público',
    'catalog',
    'Activar, configurar y publicar productos en el catálogo público.',
  ),
  permission(
    'catalog_orders.read',
    'Ver pedidos del catálogo',
    'catalog_orders',
    'Consultar pedidos recibidos desde el catálogo público.',
  ),
  permission(
    'catalog_orders.manage',
    'Gestionar pedidos del catálogo',
    'catalog_orders',
    'Aceptar, rechazar, cancelar y convertir en venta pedidos del catálogo público.',
  ),
  permission(
    'ai.use',
    'Usar PAMPA IA',
