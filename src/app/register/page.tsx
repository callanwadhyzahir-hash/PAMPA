      ...
      <section className="flex items-center justify-center bg-white px-5 py-10 sm:px-10">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            ...
            <Button className="h-11 w-full" size="lg" disabled={submitting}>{submitting && <LoaderCircle className="size-4 animate-spin" />}{submitting ? "Creando tu espacio" : "Crear cuenta"}</Button>
          </form>
