  ...
  return (
    <header className="sticky top-0 z-30 w-screen max-w-[100vw] border-b border-white/10 bg-[#0b0d0a]/95 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
        ...
        <a href="#lista" className="hidden border border-[#b8e26b] bg-[#b8e26b] px-4 py-2 text-sm font-semibold text-[#0b0d0a] transition-colors hover:bg-[#d2f58a] sm:inline-flex">
          Unirme a la beta
        </a>
